...
export class CoinbaseService {
  ...
  // conveniently, this endpoint doesn't require authentication.
  // we could use a coinbase api key and secret to authenticate, but this endpoint doesn't require it.
